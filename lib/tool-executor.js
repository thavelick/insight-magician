...
export class ToolExecutor {
  ...
  async executeTool(toolName, parameters, context = {}) {
    try {
      ...
      console.log(`✅ Tool ${toolName} executed successfully`, { 
        ...
        dataPreview: result.data ? `${Object.keys(result.data).join(', ')} (${JSON.stringify(result.data).length} chars)` : 'none',
  ...
  async executeToolCalls(toolCalls, context = {}) {
    console.log(`🛠️  Processing ${toolCalls.length} tool call(s):`, { 
    ...
    console.log(`📋 Tool execution completed. Returning ${results.length} result(s) to AI:`, {
